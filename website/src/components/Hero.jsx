    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20 px-6">
      ...
      <div className="relative z-10 text-center max-w-[720px]">
        ...
        >
          ...
          <a href="https://github.com/poorants/volox-electron" target="_blank" rel="noopener" className="inline-flex items-center gap-2.5 px-7 py-3.5 border border-violet-500/25 text-violet-200/60 font-semibold rounded-[14px] hover:bg-violet-500/8 hover:text-white hover:border-violet-400 transition-all active:scale-[0.97]">
            <GithubIcon />
            View on GitHub
          </a>
        </motion.div>
